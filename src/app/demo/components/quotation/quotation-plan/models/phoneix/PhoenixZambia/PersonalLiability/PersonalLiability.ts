...
export class PersonalLiabilityPhoneix{
    customerDetails: any;
    commonDetails: any[]=[];
                ...
                fieldGroup: [
                  {
                    ...
                    key: 'PersonalAccidental',
                    defaultValue: '0',
                    templateOptions: {
                      label: `Accidental death, bodily injury, illness, loss of or damage to property`,
                      maxLength: 15,
                      disabled: this.checkDisable('PersonalAccidental'),
                      required: true,
                      options: [
                      ],
                  ...
                  },
                  {
                    ...
                    key: 'PersonalWrongful',
                    defaultValue: '0',
                    templateOptions: {
                      label: `Wrongful Arrest and Defamation`,
                      maxLength: 15,
                      disabled: this.checkDisable('PersonalWrongful'),
                      required: true,
                      options: [
                      ],
