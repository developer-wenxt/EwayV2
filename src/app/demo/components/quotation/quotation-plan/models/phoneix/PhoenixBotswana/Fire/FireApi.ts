...
export class FireBotswanaApi{
  ...
  extendsfields:FormlyFieldConfig
    ...
    getSaveDetails(entry,IndustryId,industryTypeList,obj){
      if(entry.plantMachinery!=null && entry.plantMachinery!=''){
        let sectionId=null;
        sectionId='1';
          let subEntry={
      ...
      if(entry.stockInTrade!=null && entry.stockInTrade!=''){
        let sectionId=null;
        sectionId='1';
        let subEntry={
      ...
      if(entry.miscellaneous!=null && entry.miscellaneous!=''){
          let sectionId=null;
          sectionId='1';
          let subEntry={
          ...
          obj.SectionList.push(subEntry);
                  ...
                  if(entry.hailDamage!=null && entry.hailDamage!=''){
                      let subEntry={
                    ...
                    if(entry.rentReceivable!=null && entry.rentReceivable!=''){
                      let subEntry={
                  ...
                  if(entry.leakageExtension!=null && entry.leakageExtension!='' && entry.leakageExtensionSumInsured!=null && entry.leakageExtensionSumInsured!='0'){
                      let subEntry={
                  ...
                  if(entry.ConstructionType!=null && entry.ConstructionType!='' && entry.fireBuildingSumInsured!=null && entry.fireBuildingSumInsured!=''){
                      let subEntry={
                    ...
                    if(entry.AdditonalInflation!=null && entry.AdditonalInflation!='' && entry.fireBuildingSumInsured!=null && entry.fireBuildingSumInsured!=''){
                      let subEntry={
                        "SectionId":"1","SectionName": "Building",
                        "Status":"Y","SumInsured":entry.fireBuildingSumInsured,
                        "CoverId": "360",
                    ...
                    if(entry.PreventionofAccessSI!=null && entry.PreventionofAccessSI!='' && entry.PreventionofAccessSI!='0'){
                    
                      let subEntry={
                                          "SectionId":"1","SectionName":"Building",
                                          "Status":"Y","SumInsured":entry.PreventionofAccessSI,
                                          "CoverId": "494",
                                          "DescriptionOfRisk": null
                                        }
                                        if(IndustryId){subEntry['IndustryType'] = IndustryId;subEntry["IndustryTypeDesc"]= industryTypeList.find(ele=>ele.Code==IndustryId)?.CodeDesc}
                    ...
                    if(entry.PublicTelecommuncationSI!=null && entry.PublicTelecommuncationSI!='' && entry.PublicTelecommuncationSI!='0' && entry.PublicTelecommuncation!=null && entry.PublicTelecommuncation!='' ){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
                    ...
                    if(entry.PublicUtilitiesSI!=null && entry.PublicUtilitiesSI!='' && entry.PublicUtilitiesSI!='0' && entry.PublicUtilities!=null && entry.PublicUtilities!=''){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
                    ...
                    if(entry.contents!=null && entry.contents!='' ){
                      ...
                      sectionId='1';
                        let subEntry={
                          ...
                          "Status":"Y","SumInsured":entry.contents,
                          "CategoryId": entry.ConstructionType,
                          "CoverId": "290",
                          "DescriptionOfRisk":null
                        }
                    ...
                    if(entry.GeyserSolar!=null && entry.GeyserSolar!='' ){
                      let sectionId=null;
                      sectionId='1';
                        let subEntry={
                    ...
                    if(entry.GeyserInhouse!=null && entry.GeyserInhouse!='' ){
                      let sectionId=null;
                      sectionId='1';
                        let subEntry={
                          "SectionId": "196","SectionName":"Geyser",
                    ...
                    if(entry.CustomerSupplierSI!=null && entry.CustomerSupplierSI!='' && entry.CustomerSupplierSI!='0' && entry.CustomerSupplier!=null && entry.CustomerSupplier!=''){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
    ...
    obj.SectionList.push(subEntry);
                    ...
                    if(entry.AccidentalDamage!=null && entry.AccidentalDamage!='' && entry.AccidentalDamage!='0'){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
    ...
    obj.SectionList.push(subEntry);
                    ...
                    if(entry.ClaimPreparationCost!=null && entry.ClaimPreparationCost!='' && entry.ClaimPreparationCost!='0'){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
                    ...
                    if(entry.UnspecifiedSupplier!=null && entry.UnspecifiedSupplier!='' && entry.UnspecifiedSupplier!='0'){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
                    ...
                    if(entry.IndeminityPeriod!=null && entry.IndeminityPeriod!='' && entry.BISumInsured!=null && entry.BISumInsured!='0'){
                      let subEntry={
                        "SectionId":"1","SectionName":"Building",
