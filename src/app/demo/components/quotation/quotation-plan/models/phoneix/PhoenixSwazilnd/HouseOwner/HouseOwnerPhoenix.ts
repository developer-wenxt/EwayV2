...
export class HouseOwnerSwaziland {
  customerDetails: any;
    ...
    this.policyfields1 = {
      fieldGroup: [
        ...
        },
        {
          ...
          type: 'commaSeparator',
          props: {
            label: 'Leakage (First Loss Limit)',
            placeholder: 'Select an option',
            required: false,
            options: [
        ...
        },
        {
          ...
          type: 'commaSeparator',
          props: {
            label: 'Non-Political Riot and Strike excl RSA & Namibia',
            placeholder: 'Select an option',
            required: false,
            options: [
