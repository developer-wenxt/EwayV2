...
export class CommonProductDetailsComponent implements AfterViewInit{
  kids: any = 0;
  adult: any = 0;
  senior: any = 0;
  superSenior: any = 0;
  ...
  constructor(private route: ActivatedRoute, private router: Router, private sharedService: SharedService, private datePipe: DatePipe, private cd: ChangeDetectorRef) {
  ...
  async ngOnInit() {
    ...
    if (this.productId == '61' || this.productId == '25' || this.productId == '16' || this.productId == '39'
      || this.productId == '1' || this.productId == '14' || this.productId == '13' || this.productId == '15' || this.productId == '32' || this.productId == '49' || this.productId == '26' || this.productId == '6') { this.nonMotorProductItem = new NonMotorProducts(); console.log("Final Products", this.nonMotorProductItem); this.LocationListAlt = this.nonMotorProductItem.LocationList; this.LocationListAlt[0].LocationId = this.LocationListAlt.length; if (this.productId != '14' && this.productId != '32') this.currentSectionIndex = 0; }
  ...
  getExistingBuildingList() {
    ...
    if (this.productId == '60'
      ...
      || this.productId == '68' || this.productId == '69' || this.productId == '70' || this.productId == '71' || this.productId == '26' || this.productId == '27' || this.productId == '79' || this.productId == '84'
      ...
      (data: any) => {
        if (data.Result) {
          if (data.Result) {
            ...
            if (this.productId != '59' && this.productId != '19' && this.productId != '63' && this.productId != '61' && this.productId != '25' && this.productId != '16' && this.productId != '1' && this.productId != '14' && this.productId != '15' && this.productId != '32' && this.productId != '6' && this.productId != '13' && this.productId != '39' && this.productId != '66' && this.productId != '67' && this.productId != '68' && this.productId != '69'
            ...
            if (this.productId == '61' || this.productId == '25' || (this.productId == '16' && this.insuranceId != '100046' && this.insuranceId != '100047' && this.insuranceId != '100048' && this.insuranceId != '100049' && this.insuranceId != '100050') || this.productId == '1' || this.productId == '14'
    ...
    while (year >= currentYear) {
      ...
      if (year == currentYear) {
        ...
        if (this.productId != '46') {
          ...
          if (referenceNo) {
            this.requestReferenceNo = referenceNo;
            if (this.productId != '19' && this.productId != '59' && this.productId != '24' && this.productId != '46' && this.productId != '4' && this.productId != '67' && this.productId != '79' && this.productId != '84') this.setFormValues();
  ...
  onSubmit(type) {
    ...
    if (valid) {
      if (this.productId == '43' || this.productId == '42'
      ...
      else if (this.productId == '1' || ((this.productId == '14' || this.productId == '32') && this.insuranceId != '100046' && this.insuranceId != '100047' && this.insuranceId != '100048' && this.insuranceId != '100049' && this.insuranceId != '100050') || this.productId == '15' || this.productId == '13' || this.productId == '61' || ((this.productId == '25' || this.productId == '39') && this.insuranceId != '100046' && this.insuranceId != '100047' && this.insuranceId != '100048' && this.insuranceId != '100049' && this.insuranceId != '100050') || (this.productId == '16' && this.insuranceId != '100046' && this.insuranceId != '100047' && this.insuranceId != '100048' && this.insuranceId != '100049' && this.insuranceId != '100050') || this.productId == '6') {
        ...
        if (entry && this.productId == '61') {
          ...
          if (this.productItem.Section != null && this.productItem.Section != '') {
            ...
            obj["CoverId"] = this.productItem.Section == '107' ? '244' : this.productItem.Section == '110' ? '247' : '251'
      ...
      if (entry.LocationName != null && entry.LocationName != '') {
        ...
        if (this.productId == '61') {
          ...
          for (let subEntry of entry.SectionList) {
            ...
            if (subEntry.MoneyInSafe != null && subEntry.MoneyInSafe != '' && subEntry.MoneyInSafe != '0' && subEntry.MoneyInSafe != 0) {
              let subObj = {
                "SectionId": "42",
                "SectionName": "Money",
                "IndustryId": this.IndustryId,
                "RiskId": null,
                "CoverId": "77",
                "StrongroomSi": subEntry.MoneyInSafe,
                "RegionCode": subEntry.RegionCode,
                "DistrictCode": subEntry.DistrictCode,
                "CoveringDetails": subEntry.CoveringDetails,
                "DescriptionOfRisk": subEntry.DescriptionOfRisk
          ...
          if (this.occupationList.length != 0) {
            ...
            for (let i = 0; i < this.occupationList.length; i++) {
              ...
              if (i == this.occupationList.length - 1) {
                ...
                if (this.productId != '59' && this.productId != '66' && this.productId != '68' && this.productId != '69' && this.productId != '70' && this.productId != '71' && this.productId != '72' && this.productId != '75' && this.productId != '78' && this.productId != '77' && this.productId != '76' && this.productId != '48' && this.productId != '73' && this.productId != '49' && this.productId != '74' && this.productId != '13' && this.productId != '6' && this.productId != '19' && this.productId != '24' && this.productId != '14' && this.productId != '15' && this.productId != '32' && this.productId != '57' && this.productId != '60') {
                  ...
                  if (referenceNo) {
                    this.requestReferenceNo = referenceNo;
                    if (this.productId != '19' && this.productId != '24' && this.productId != '46' && this.productId != '4' && this.productId != '63' && this.productId != '61' && this.productId != '67' && this.productId != '79' && this.productId != '84') this.setFormValues();
            ...
            if (this.productId != '14' && this.productId != '15' && this.productId != '59' && this.productId != '66') {
              ...
              if (referenceNo) {
                ...
                else if (this.productId != '24' && this.productId != '46' && this.productId != '4' && this.productId != '61' && this.productId != '63' && this.productId != '79' && this.productId != '84') this.setFormValues();
              }
  ...
  async getCRMCustomerDetails(enqId: any) {
    const urlLink = `${this.CommonApiUrl}crm/integration/getEnqiryDetail/${enqId}`;

    try {
      const observable = await this.sharedService.onGetMethodAsync(urlLink);

      const res: any = await firstValueFrom(observable);
